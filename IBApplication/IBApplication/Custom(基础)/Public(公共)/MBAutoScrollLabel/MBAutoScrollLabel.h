...
typedef NS_ENUM(NSInteger, MBAutoScrollDirection) {
    MBAutoScrollDirectionRight,
    MBAutoScrollDirectionLeft
};

@interface MBAutoScrollLabel : UIView <UIScrollViewDelegate>

@property (nonatomic) MBAutoScrollDirection scrollDirection;

...
@interface NSBallLoadingView () <CAAnimationDelegate>
...
@implementation NSBallLoadingView
...
void resetData(NSBallLoadingView *obj,CALayer **firstLayer, CALayer **secondLayer, float *radius, CGPoint *point) {
...
@implementation NSCircleLoadingView
...
@interface NSTriangleLoadingView ()
...
@implementation NSTriangleLoadingView

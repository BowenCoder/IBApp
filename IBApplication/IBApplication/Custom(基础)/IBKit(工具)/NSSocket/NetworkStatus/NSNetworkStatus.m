...
@implementation NSNetworkStatus

+ (instancetype)shareNetworkStatus {
    
    static NSNetworkStatus *instance = NULL;
...
- (void)receiveReachabilityChangedNotification:(NSNotification *)notification {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kNSReachabilityChangedNotification object:nil];
}
...
- (NSNetworkModeStatus)currentNetworkStatus {
    ...
    switch (status) {
        case NotReachable:
            return NSNotReachable;
            break;
        case ReachableViaWiFi:
            return NSReachableViaWiFi;
            break;
        case ReachableViaWWAN:
            return NSReachableViaWWAN;
            break;
        default:
            return NSNotReachable;
            break;
